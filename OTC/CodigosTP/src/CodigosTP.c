...
// MPU9250 Address
MPU9250_address_t addrIMU = MPU9250_ADDRESS_0; // If MPU9250 AD0 pin is connected to GND
//MPU9250_address_t addrIMU = MPU9250_ADDRESS_1; // If MPU9250 AD0 pin is no connected to GND
